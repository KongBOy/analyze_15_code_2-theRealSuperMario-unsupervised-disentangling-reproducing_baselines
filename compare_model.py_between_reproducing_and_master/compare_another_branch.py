...
class Model:
    ...
    def graph(self):
        ...
        with tf.variable_scope("transform"):
            ...
            transform_mesh_out_prod = tf.einsum('aijm,aijn->aijmn', self.transform_mesh, self.transform_mesh)  # [2, 64, 64, 2, 2
            mu_out_prod = tf.einsum('akm,akn->akmn', self.mu_t, self.mu_t)  # [2, 16, 2, 2]
