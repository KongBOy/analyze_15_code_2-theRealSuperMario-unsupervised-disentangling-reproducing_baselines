...
def load_train_from_csv(
    arg,
    data_root="/export/home/sabraun/code/nips19/data/exercise_data/exercise_dataset/",
    data_csv="/export/home/sabraun/code/nips19/data/exercise_data/exercise_dataset/csvs/instance_level_train_split.csv",
    id_col_name="id",
    fname_col_name="im1",
):
    import pandas as pd
...
def load_test_from_csv(
    arg,
    data_root="/export/home/sabraun/code/nips19/data/exercise_data/exercise_dataset/",
    data_csv="/export/home/sabraun/code/nips19/data/exercise_data/exercise_dataset/csvs/instance_level_test_split.csv",
    id_col_name="id",
    fname_col_name="im1",
):
    import pandas as pd
